...
export const NamiTechLogo: React.FC<LogoProps> = ({
  size = "md",
  withTagline = false,
}) => {
  const iconSize =
  ...
  return (
    ...
    >
      {/* Dynamic SVG Icon recreating the NamiTech logo: 'N' connected nodes + camera lens */}
      <div
        className={`relative ${iconSize} flex-shrink-0 flex items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500/20 via-blue-600/30 to-slate-900 border border-cyan-400/40 p-1.5 shadow-[0_0_15px_rgba(6,182,212,0.3)] group-hover:border-cyan-300 transition-all duration-300`}
      >
        <svg
          viewBox="0 0 100 100"
      ...
      <div className="flex flex-col">
        <div className="flex items-baseline leading-none">
          <span
            className={`${titleClass} font-extrabold tracking-tight text-white font-['Space_Grotesk']`}
          >
