...
export const SERVICES = [
  {
    ...
    description: "High-speed internet deployment, fiber configuration, router setup, structured LAN/WAN cabling, and WiFi dead-zone elimination for homes and offices across Kenya.",
    features: [
    ...
    targetLocations: ["Nairobi Estates & CBD", "Mombasa Coastal Region", "Kisumu & Western Kenya", "Nakuru & Central Rift"]
  },
  {
    id: "cctv-security",
    ...
    description: "Professional HD/IP CCTV camera installation, remote mobile view setup, maintenance, and smart security monitoring for residential and commercial properties.",
    features: [
    ...
    targetLocations: ["Commercial Buildings & Warehouses", "Private Gated Communities", "Retail Stores & Supermarkets", "Educational & Healthcare Facilities"]
  },
  {
    ...
    description: "Organized server rack installations, patch panel dressing, cable containment, and certified copper/fiber backbone solutions that eliminate downtime.",
    features: [
    ...
    targetLocations: ["Corporate Offices", "Fintech & Call Centers", "Hospitals & Schools", "Industrial Yards"]
  },
  {
    ...
    description: "Keyless door access, biometric time-and-attendance systems, and video gate intercoms integrated directly into your local network.",
    features: [
    ...
    targetLocations: ["Offices", "Apartment Blocks", "Warehouses", "Institutions"]
  }
];
...
export const WHY_CHOOSE_US = [
  {
    ...
    icon: "Compass",
    description: "Tailored networking and surveillance solutions built specifically for Kenyan businesses, estates, and homes. We understand local ISP dynamics and power infrastructure."
  },
  {
    title: "Fast Installation",
    icon: "Zap",
    description: "Rapid deployment with neat, structured cabling and minimal downtime. Most residential WiFi and CCTV jobs completed within 24 to 48 hours."
  },
  {
    title: "24/7 Support & Maintenance",
    icon: "Clock",
    description: "Dedicated technical assistance whenever you need it. Our rapid-response technicians in Nairobi and across Kenya keep your network and cameras online."
  },
  {
    title: "Crystal-Clear Remote Viewing",
    icon: "Smartphone",
    description: "Access your CCTV camera feeds anywhere in the world on iOS, Android, and Windows with low latency and zero complex port forwarding."
  }
];
